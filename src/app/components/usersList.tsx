          ...
          {users.map((user: User) => (
            <tr key={user.id} className="border-b">
              <td className="py-4 px-4 flex items-center">
                ...
                />
                <div>
                  <p className="text-[10px] md:text-sm font-semibold text-black">{user.username}</p>
                </div>
              </td>
              <td className="text-[10px] py-4 px-4 text-black md:text-xs">{user.email}</td>
              <td className="text-[10px] py-4 px-4 text-black md:text-xs">{user.role}</td>
            </tr>
          ))}
        </tbody>
      </table>
