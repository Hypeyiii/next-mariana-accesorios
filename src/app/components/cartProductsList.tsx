...
export default function CartProductsList() {
  ...
  if (cartProducts.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-screen gap-y-5 w-[50%] md:w-[20%] mx-auto text-black">
  ...
  return (
    <div className="w-[90%] m-auto items-center justify-center mt-24 grid grid-cols-4 gap-4">
